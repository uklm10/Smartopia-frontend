...
function register() {
    ...
    return (
        ...
        <div className="registerPage">
            ...
            <h1 className='main_heading'>Create an account</h1>
            ...
            <div className="data-div main">
                ...
                <Alert type={alertType}/>
                    <div className='input-container'>
                        ...
                        <span className='man'><i aria-hidden="true" class="fa fa-user"></i></span>
